wineInventory.controller('iPhoneViewReconcileBottleController',
    [
        '$scope',
        '$uibModal',
        '$location',
    ...
    function($scope, $uibModal, $location, Data, $window, $routeParams, $filter, AsOfDate) {
        ...
        var locationName = Data.getViewName();

        var gridData  = Data.getIphoneReconcileBottles();
        var binName = gridData[0].Bin;

        Data.setViewName(locationName + " - " + txtCommon.bin + ": " + binName);
